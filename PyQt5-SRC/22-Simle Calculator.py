...
class main(QWidget):
    def __init__(self):
        ...
        self.button_list = [QPushButton("x²"),
                           QPushButton("C"),
                           QPushButton("←" ),
                           QPushButton("/"),
                           QPushButton("7"),
        ...
        for i in range(4):
            self.grid.addWidget(self.button_list[i], 0, i, 1, 1)
